...
Não aplicável: este repositório não publica APIs. Os contratos da solução estão no [índice central de APIs e testes](https://github.com/tiagomiele/backend/blob/documentation/docs/evidencias.md).
